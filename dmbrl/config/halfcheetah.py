...
class HalfCheetahConfigModule:
    ...
    # jsw handles np arrays and tensor flow objects
    # I dont know what they're trying to do with the observations,
    # my guess is taking z, then sine of rooty angle, cos of rooty angle, then thigh directly
    @staticmethod
    def obs_preproc(obs):
